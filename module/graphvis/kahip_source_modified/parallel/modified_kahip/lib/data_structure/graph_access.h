...
class graph_access {
        ...
        public:
                ...
                //MODIFIED: Added VertexsetIndex
                // PartitionID getVertexsetIndex(NodeID node);
                // void setVertexsetIndex(NodeID node, PartitionID id);
...
//MODIFIED: Added vertexsetIndex
// inline PartitionID graph_access::getVertexsetIndex(NodeID node) {
// #ifdef NDEBUG
...
// inline void graph_access::setVertexsetIndex(NodeID node, PartitionID id) {
// #ifdef NDEBUG
